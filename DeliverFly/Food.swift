...
extension Array where Element == Food {
    ...
    static var subway: [Food] {
        [Food(id: "300",
         ...
         Food(id: "302",
              name: "Salad",
              description: "Contains a double serving of chicken with melted mozzarella and cheddar mix, on iceberg, tomatoes, cucumbers, green peppers, olives 4and onions. Season with Crispy onion and sweet sauc!.",
              image: "salad",
               ingredients: [],
              price: 7.39),
         Food(id: "303",
